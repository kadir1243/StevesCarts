...
public class StevesCartsModules {
	...
	public static final ModuleType<RailerModule> RAILER = register("railer", new ModuleType<>(RailerModule::new, StevesCarts.id("railer"), 3, EnumSet.of(ModuleSide.TOP), ModuleGroup.ATTACHMENT, true, false, false, null, null));
