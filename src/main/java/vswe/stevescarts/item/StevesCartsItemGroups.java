...
public class StevesCartsItemGroups {
	...
	public static final ItemGroup MODULES = FabricItemGroupBuilder.create(StevesCarts.id("modules_group")).icon(() -> new ItemStack(StevesCartsModuleTypes.GALGADORIAN_HULL.getItem())).build();
}
