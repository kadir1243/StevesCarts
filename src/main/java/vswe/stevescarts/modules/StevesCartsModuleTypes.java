...
public class StevesCartsModuleTypes {
	...
	public static final MinecartModuleType<TankModule> ADVANCED_TANK = MinecartModuleType.<TankModule>builder().id("advanced_tank").category(ModuleCategory.STORAGE).factory((entity, type) -> new TankModule(entity, type, FluidValue.BUCKET.multiply(32))).sides(ModuleSide.TOP, ModuleSide.CENTER).hasRenderer().noRenderTop().moduleCost(54).buildAndRegister();
	...
	public static final MinecartModuleType<SolarEngineModule> SOLAR_ENGINE = MinecartModuleType.<SolarEngineModule>builder().id("solar_engine").category(ModuleCategory.ENGINE).factory((minecart, type) -> new SolarEngineModule(minecart, type, 100000L)).sides(ModuleSide.CENTER, ModuleSide.TOP).hasRenderer().noRenderTop().moduleCost(12).buildAndRegister();
	public static final MinecartModuleType<SolarEngineModule> ADVANCED_SOLAR_ENGINE = MinecartModuleType.<SolarEngineModule>builder().id("advanced_solar_engine").category(ModuleCategory.ENGINE).factory((minecart, type) -> new SolarEngineModule(minecart, type, 200000L)).sides(ModuleSide.CENTER, ModuleSide.TOP).hasRenderer().noRenderTop().moduleCost(20).buildAndRegister();
