...
public class SideChestsRenderer extends ModuleRenderer<ChestModule> {
	...
	@Override
	public void render(ChestModule module, float entityYaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int entityLight) {
